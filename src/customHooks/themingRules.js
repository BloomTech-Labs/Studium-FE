...
export const getThemingRules = () => [
  ...
  createRule(THEMING_VARIABLES.BACKGROUND, THEMING_VALUES.DARK,
    [
      ...
      APP_PATHS.DASHBOARD_PATH, APP_PATHS.GAME_PATH, APP_PATHS.PREVIEW_DECK_PATH
    ],
    APP_VIEW_DESKTOP,
  ...
  createRule(THEMING_VARIABLES.BACKGROUND, THEMING_VALUES.DARK,
    ...
    [
      APP_PATHS.DASHBOARD_PATH, APP_PATHS.PREVIEW_DECK_PATH, APP_PATHS.GAME_PATH,
    ],
    APP_VIEW_MOBILE,
  ), createRule(THEMING_VARIABLES.FOOTER, THEMING_VALUES.HIDDEN,
    [
      APP_PATHS.DASHBOARD_PATH, APP_PATHS.PREVIEW_DECK_PATH,
      APP_PATHS.GAME_PATH, APP_PATHS.CREATE_DECK_PATH, APP_PATHS.LANDING_PAGE,
      APP_PATHS.SIGN_IN_PATH, APP_PATHS.SIGN_UP_PATH, APP_PATHS.TESTING
    ],
    APP_VIEW_DESKTOP,
  ),
];
