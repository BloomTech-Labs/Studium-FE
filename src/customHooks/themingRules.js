...
export const getThemingRules = () => [
  ...
  createRule( THEMING_VARIABLES.NAV_STYLE, THEMING_VALUES.LIGHT,
    [
      APP_PATHS.SIGN_UP_PATH, APP_PATHS.DASHBOARD_PATH,
      APP_PATHS.CREATE_DECK_PATH, APP_PATHS.LANDING_PAGE,
    ], APP_VIEW_DESKTOP,
  ), createRule( THEMING_VARIABLES.NAV_STYLE, THEMING_VALUES.DARK,
    [
      APP_PATHS.CREATE_DECK_PATH, APP_PATHS.DASHBOARD_PATH, APP_PATHS.GAME_PATH,
      APP_PATHS.PREVIEW_DECK_PATH,
    ], APP_VIEW_MOBILE,
  ), createRule( THEMING_VARIABLES.NAV_STYLE, THEMING_VALUES.HIDDEN,
